...
const BCIScenarioPlanning = () => {
    ...
    const uncertainties = [
        // POLITICAL (8 factors)
        { id: 1, category: 'Political', name: 'Global BCI Governance Framework Development', description: 'Whether international bodies establish unified standards for BCI regulation vs. fragmented national approaches', impact: 9, uncertainty: 8 },
        { id: 2, category: 'Political', name: 'Government Funding for BCI Research', description: 'The level of public investment in BCI development and whether it prioritizes military vs. civilian applications', impact: 8, uncertainty: 7 },
        ...
        { id: 4, category: 'Political', name: 'Military BCI Development and Deployment', description: 'The extent to which military applications drive BCI advancement and potential dual-use implications', impact: 7, uncertainty: 8 },
        { id: 5, category: 'Political', name: 'Healthcare System Integration Mandates', description: 'Whether governments mandate BCI integration into national health systems for certain conditions', impact: 8, uncertainty: 7 },
        ...
        { id: 7, category: 'Political', name: 'Cross-Border BCI Data Flow Restrictions', description: 'The degree of restrictions on international transfer of neural data for research and commercial purposes', impact: 7, uncertainty: 8 },
        { id: 8, category: 'Political', name: 'Public Sector BCI Procurement', description: 'Government adoption of BCI technology for public services and employment', impact: 6, uncertainty: 8 },

        // ECONOMIC (7 factors)
        { id: 9, category: 'Economic', name: 'BCI Market Valuation and Investment', description: 'The scale of venture capital and corporate investment flowing into the BCI sector', impact: 8, uncertainty: 7 },
        { id: 10, category: 'Economic', name: 'Insurance Coverage for BCI Therapies', description: 'Whether private and public insurers cover BCI treatments and the extent of coverage', impact: 9, uncertainty: 8 },
        { id: 11, category: 'Economic', name: 'Cost Trajectory of BCI Devices', description: 'The speed at which BCI technology becomes affordable for mass-market adoption', impact: 10, uncertainty: 7 },
        ...
        { id: 13, category: 'Economic', name: 'BCI-Enabled Productivity Gains', description: 'The measurable productivity improvements from BCI use in professional contexts', impact: 8, uncertainty: 8 },
        ...
        { id: 15, category: 'Economic', name: 'BCI Infrastructure Investment', description: 'The level of capital expenditure on neural interface infrastructure and supporting systems', impact: 7, uncertainty: 7 },
        ...
        { id: 17, category: 'Social', name: 'Formation of Cognitive Inequality', description: 'Whether society stratifies into enhanced and non-enhanced classes with different capabilities', impact: 10, uncertainty: 8 },
        { id: 18, category: 'Social', name: 'Cultural Attitudes Toward Neural Privacy', description: 'How different cultures and demographics view the sanctity of mental privacy', impact: 9, uncertainty: 8 },
        { id: 19, category: 'Social', name: 'BCI Adoption Among Healthcare Professionals', description: 'The rate at which medical professionals recommend and use BCI therapies', impact: 8, uncertainty: 7 },
        { id: 20, category: 'Social', name: 'Social Movements for/Against BCIs', description: 'The emergence and influence of advocacy groups either promoting or resisting BCI adoption', impact: 7, uncertainty: 8 },
        { id: 21, category: 'Social', name: 'Generational Divide in BCI Acceptance', description: 'Whether younger generations embrace BCIs while older generations resist, creating adoption gaps', impact: 8, uncertainty: 7 },
        { id: 22, category: 'Social', name: 'BCI Use in Education and Learning', description: 'The integration of BCIs into educational settings for enhanced learning outcomes', impact: 8, uncertainty: 8 },
        { id: 23, category: 'Social', name: 'Impact on Human Identity and Authenticity', description: 'Philosophical and psychological questions about what makes us "human" with neural augmentation', impact: 9, uncertainty: 9 },

        // TECHNOLOGICAL (10 factors)
        ...
        { id: 25, category: 'Technological', name: 'BCI-AI Integration Sophistication', description: 'The degree to which artificial intelligence can interpret and predict from brain signals', impact: 9, uncertainty: 8 },
        { id: 26, category: 'Technological', name: 'Bidirectional BCI Development', description: 'Progress in not just reading but also writing information directly to the brain', impact: 10, uncertainty: 9 },
        { id: 27, category: 'Technological', name: 'Long-Term BCI Safety and Biocompatibility', description: 'Evidence of safety for extended use (10+ years) and resolution of immune response issues', impact: 10, uncertainty: 8 },
        { id: 28, category: 'Technological', name: 'Wireless BCI Energy Efficiency', description: 'Battery life and energy requirements for wireless brain implants', impact: 8, uncertainty: 7 },
        { id: 29, category: 'Technological', name: 'Cybersecurity of Neural Devices', description: 'The robustness of BCIs against hacking, manipulation, and unauthorized access', impact: 10, uncertainty: 8 },
        { id: 30, category: 'Technological', name: 'Multi-Brain Interface Development', description: 'Technology enabling direct brain-to-brain communication between individuals', impact: 8, uncertainty: 9 },
        { id: 31, category: 'Technological', name: 'BCI Data Compression and Storage', description: 'The efficiency of storing, processing, and transmitting large volumes of neural data', impact: 7, uncertainty: 7 },
        { id: 32, category: 'Technological', name: 'Surgical Procedure Simplification', description: 'Whether BCI implantation becomes an outpatient procedure with minimal recovery time', impact: 9, uncertainty: 8 },
        { id: 33, category: 'Technological', name: 'BCI Interoperability Standards', description: 'Development of universal protocols allowing different BCI systems to work together', impact: 8, uncertainty: 8 },

        // LEGAL (6 factors)
        { id: 34, category: 'Legal', name: 'Liability Framework for BCI Malfunctions', description: 'Legal clarity on who is responsible when BCIs cause harm (manufacturer, surgeon, user)', impact: 9, uncertainty: 9 },
        ...
        { id: 36, category: 'Legal', name: 'Admissibility of Brain Data in Court', description: 'Whether neural data can be used as evidence in legal proceedings and under what conditions', impact: 8, uncertainty: 9 },
        { id: 37, category: 'Legal', name: 'Employment Discrimination Based on BCI Use', description: 'Legal protections against requiring or discriminating based on BCI enhancement status', impact: 9, uncertainty: 8 },
        { id: 38, category: 'Legal', name: 'Intellectual Property for Neural Data', description: 'Patent and IP frameworks for discoveries or creations made using BCIs', impact: 7, uncertainty: 8 },
        { id: 39, category: 'Legal', name: 'Right to Cognitive Liberty', description: 'Legal recognition of the right to mental self-determination and freedom from neural manipulation', impact: 9, uncertainty: 9 },

        // ENVIRONMENTAL (5 factors)
        { id: 40, category: 'Environmental', name: 'BCI Electronic Waste Management', description: 'The environmental impact of disposing outdated or removed neural implants', impact: 6, uncertainty: 7 },
        { id: 41, category: 'Environmental', name: 'Rare Earth Materials for BCI Manufacturing', description: 'Availability and sustainability of materials needed for advanced neural electrodes', impact: 7, uncertainty: 7 },
        { id: 42, category: 'Environmental', name: 'Energy Consumption of BCI Infrastructure', description: 'The carbon footprint of data centers and computing infrastructure supporting BCIs', impact: 6, uncertainty: 6 },
        { id: 43, category: 'Environmental', name: 'BCI Applications for Environmental Monitoring', description: 'Using enhanced cognition to better understand and respond to ecological challenges', impact: 5, uncertainty: 8 },
        { id: 44, category: 'Environmental', name: 'Sustainable BCI Supply Chain', description: 'The extent to which BCI manufacturing adopts circular economy principles', impact: 5, uncertainty: 7 },
    ];
    ...
    // Stage 4: Driver Connections (mapping relationships)
                    ...
                    {activeStage === 1 && (
                        <div className="space-y-6">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-xl text-purple-200">44 Critical Uncertainties Across PESTLE Dimensions</p>
                            </div>
                            ...
                            {viewType === 'category' ? (
                                ...
                                <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 p-8 rounded-xl">
                                    <div className="text-center mb-6">
                                        <div className="inline-flex items-center gap-3 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl p-4 shadow-2xl border-4 border-white/50">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm">Complete PESTLE Overview: 44 Critical Factors</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-4 text-center text-sm text-purple-200 bg-purple-800/30 p-3 rounded-lg">
                                        All 44 uncertainties organized by PESTLE dimension. Hover over any factor for detailed information.
                                    </div>
                                </div>
                            ) : viewType === 'mindmap' ? (
                                /* Proper Mind Map Visualization with Large Canvas */
                                <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 p-6 rounded-xl">
                                    <div className="overflow-auto max-h-[800px]" style={{ maxWidth: '100%' }}>
                                        <div className="relative bg-purple-900/30 rounded-lg" style={{ width: '2000px', height: '1400px' }}>
                                            {/* Central Node */}
                                            <div className="absolute" style={{ left: '1000px', top: '700px', transform: 'translate(-50%, -50%)', zIndex: 30 }}>
                                                <div className="bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl p-8 shadow-2xl border-4 border-white">
                                                    <div className="text-center">
                                                        ...
                                                        <p className="text-sm mt-2 opacity-90">44 Critical Uncertainties</p>
                                            ...
                                            <svg className="absolute inset-0 pointer-events-none" style={{ width: '2000px', height: '1400px', zIndex: 1 }}>
                                                {Object.keys(pestleColors).map((category, idx) => {
                                                    ...
                                                    const cx = 1000 + Math.cos(angle) * categoryRadius;
                                                    ...
                                                    const categoryUncertainties = uncertainties.filter(u => u.category === category);
                                                    const displayUncertainties = categoryUncertainties.slice(0, 6);
                                                    ...
                                                    return (
                                                        <g key={`lines-${category}`}>
                                                            ...
                                                            {displayUncertainties.map((uncertainty, uIdx) => {
                                                                const subAngle = angle + ((uIdx - 2.5) * 0.4);
                                                                const subRadius = 200;
                                                    ...
                                                    <div key={category}>
                                                        ...
                                                        >
                                                            ...
                                                            <p className="text-sm text-center font-semibold mt-1">
                                                                Showing top {displayUncertainties.length}
                                                            </p>
                                                        </div>

                                                        {/* Critical uncertainties from this category */}
                                                        {displayUncertainties.map((uncertainty, uIdx) => {
                                                            const subAngle = angle + ((uIdx - 2.5) * 0.4);
                                                            const subRadius = 200;
                                                            const ux = cx + Math.cos(subAngle) * subRadius;
                                                            ...
                                                            return (
                                                                ...
                                                                >
                                                                    <div className={`${pestleColors[category]} rounded-xl p-3 shadow-xl border-2 ${isCritical ? 'border-pink-300 ring-2 ring-pink-400' : 'border-white/50'
                                            ...
                                            {selectedUncertainty && (
                                                <div
                                                    ...
                                                    style={{ left: '1000px', top: '20px', transform: 'translateX(-50%)', zIndex: 40 }}
                                                >
                                    ...
                                    <div className="mt-4 text-center text-sm text-purple-200 bg-purple-800/30 p-3 rounded-lg">
                                        Comprehensive mind map showing top uncertainties from each PESTLE dimension. Scroll to explore the full map. Critical drivers (top 10) are marked with pink numbers.
                                    </div>
                                </div>
                            ) : (
                                <>
                                    ...
                                    {/* Uncertainties Grid - Now always showing full info */}
                                    <div className="grid md:grid-cols-2 gap-4 max-h-[600px] overflow-y-auto pr-2">
                                        {filteredUncertainties.map((uncertainty) => (
                                            <div
                                                key={uncertainty.id}
                                                className={`${pestleColors[uncertainty.category]}/20 border-2 border-${pestleColors[uncertainty.category].replace('bg-', '')}/50 hover:border-white/50 p-4 rounded-xl transition-all`}
                                            >
                                                <div className="flex items-start justify-between gap-2 mb-2">
                                                    <h4 className="font-bold text-base flex-1">{uncertainty.name}</h4>
                                                    <span className={`${pestleColors[uncertainty.category]} px-2 py-1 rounded text-xs font-semibold flex-shrink-0`}>
                                                        {uncertainty.category}
                                                    </span>
                                                </div>
                                                <p className="text-sm text-purple-100 mb-3">{uncertainty.description}</p>
                                                <div className="flex gap-4 text-sm">
                                                    <div className="flex items-center gap-1">
                                                        <span className="font-semibold">Impact:</span>
                                                        <span className="text-pink-300">{uncertainty.impact}/10</span>
                                                    </div>
                                                    <div className="flex items-center gap-1">
                                                        <span className="font-semibold">Uncertainty:</span>
                                                        <span className="text-yellow-300">{uncertainty.uncertainty}/10</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ))}
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <ul className="text-sm text-purple-200 space-y-1">
                                            ...
                                            <li>• <span className="font-semibold">Be Comprehensive:</span> 44 factors across all PESTLE dimensions</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 p-8 rounded-xl">
                                <div className="relative bg-purple-950/40 rounded-lg" style={{ height: '700px', padding: '50px 40px' }}>
                                    ...
                                    {/* Quadrant Labels */}
                                    <div className="absolute top-16 left-16 text-xs font-semibold text-purple-300 bg-black/30 px-2 py-1 rounded z-10">
                                    ...
                                    <div className="absolute bottom-24 right-16 text-xs font-semibold text-purple-300 bg-black/30 px-2 py-1 rounded z-10">
                                    ...
                                    <div className="absolute inset-0" style={{ margin: '50px 40px' }}>
                                        ...
                                        {/* ALL 44 Dots - Improved positioning */}
                                        {uncertainties.map((u) => {
                                            const isCritical = criticalDrivers.some(d => d.id === u.id);
                                            const rank = isCritical ? criticalDrivers.findIndex(d => d.id === u.id) + 1 : null;

                                            // Map impact and uncertainty to percentage positions
                                            // Uncertainty (0-10) maps to X-axis (left to right)
                                            // Impact (0-10) maps to Y-axis (bottom to top, so we invert)
                                            const x = ((u.uncertainty - 0) / (10 - 0)) * 100;
                                            const y = ((10 - u.impact) / (10 - 0)) * 100;
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={`absolute rounded-full cursor-pointer transition-all ${
                                                        isCritical ? 'bg-pink-400 ring-2 ring-pink-300/50' : 'bg-purple-400'
                                                    } ${
                                                    ...
                                                    style={{
                                                        ...
                                                        boxShadow: isCritical
                                                            ? '0 4px 10px rgba(244, 114, 182, 0.5)'
                                                            : '0 2px 6px rgba(167, 139, 250, 0.4)',
                                                    }}
                                                >
                                                    {rank && rank <= 10 && (
                            ...
                            <div className="bg-purple-700/30 p-4 rounded-xl text-sm text-purple-200">
                                <p className="font-semibold mb-2 text-base">How to read the matrix:</p>
                                <ul className="space-y-1.5">
                                    <li>• <span className="font-semibold text-white">ALL {uncertainties.length} uncertainties are plotted</span> on the matrix as interactive points</li>
                                    <li>• <span className="font-semibold text-pink-300">Large pink dots with numbers (1-10)</span> = Top 10 Critical Scenario Drivers (all numbered for easy reference to list below)</li>
                                    <li>• <span className="font-semibold text-white">Top 3 critical drivers have text labels</span> positioned to avoid overlap</li>
                                    <li>• <span className="font-semibold text-purple-300">Smaller purple dots</span> = Other {uncertainties.length - criticalDrivers.length} factors (all hoverable)</li>
                                    <li>• <span className="font-semibold text-pink-300">Top-right quadrant</span> = Critical Scenario Drivers zone (high impact + high uncertainty)</li>
                    ...
                    {activeStage === 3 && (
                        <div className="space-y-6">
                                ...
                                <div className="relative" style={{ height: '500px' }}>
                                    ...
                                    {criticalDrivers.map((driver, idx) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <span className="text-xs font-bold text-center px-1" style={{ fontSize: '8px', lineHeight: '1.1' }}>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="bg-purple-800/30 p-6 rounded-xl">
                                    <h3 className="text-lg font-bold mb-3">Connection Types</h3>
                                    <div className="space-y-2 text-sm">
                                        <div className="flex items-center gap-2">
                                            <div className="w-8 h-0.5 bg-purple-400"></div>
                                            <span>Cause-Effect Relationship</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                ...
                                <div className="bg-yellow-900/30 p-6 rounded-xl">
                                    ...
                                    <p className="text-sm text-yellow-100">
                                        Drivers with 2+ connections are highlighted in yellow. These are the forces that,
                                    ...
                                    {criticalDrivers
                                        ...
                                        .map(driver => (
                                            <div key={driver.id} className="flex items-center gap-3 bg-black/20 p-3 rounded-lg">
                                                <div className="bg-yellow-500 w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0">
                                                    {driver.connections}
                                                </div>
                                                <div>
