                    ...
                    {activeStage === 1 && (
                        <div className="space-y-6">
                            ...
                            {viewType === 'category' ? (
                                ...
                                <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 rounded-xl">
                                    <div className="relative bg-purple-900/30 rounded-lg" style={{ height: '900px', paddingTop: '40px', paddingBottom: '40px' }}>
                                            {/* Central Node */}
                                            <div className="absolute" style={{ left: '24.23%', top: '50%', transform: 'translate(-50%, -50%)', zIndex: 30 }}>
                                            ...
                                            <svg className="absolute inset-0 pointer-events-none" style={{ width: '100%', height: '100%', zIndex: 1 }}>
                                                {Object.keys(pestleColors).map((category, idx) => {
                                                    ...
                                                    // Convert to percentages: 330px out of 2600px = 12.69%
                                                    const categoryRadius = 12.69;
                                                    const centerX = 24.23; // 630/2600
                                                    const centerY = 50; // 700/1400
                                                    ...
                                                    return (
                                                        <g key={`lines-${category}`}>
                                                            ...
                                                            {displayUncertainties.map((uncertainty, uIdx) => {
                                                                ...
                                                                // Convert 220px out of 2600px = 8.46%
                                                                const subRadius = 8.46;
                                            ...
                                            {selectedUncertainty && (
                                                <div
                                                    ...
                                                    style={{ left: '24.23%', top: '20px', transform: 'translateX(-50%)', zIndex: 40 }}
                                                >
                                            ...
                                            <div className="absolute text-sm text-center text-purple-200 bg-purple-800/30 p-3 rounded-lg max-w-3xl" style={{ left: '24.23%', bottom: '20px', transform: 'translateX(-50%)', zIndex: 5 }}>
