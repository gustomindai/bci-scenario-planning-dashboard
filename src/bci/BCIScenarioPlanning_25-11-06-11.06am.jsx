...
import { Brain, Calendar, Search, Network, Zap, AlertCircle, TrendingUp, Globe, Lightbulb, Target, BarChart3, Shield, ArrowRight, CheckCircle, XCircle, AlertTriangle, Activity } from 'lucide-react';
                    ...
                    {activeStage === 8 && (
                        <div className="space-y-8">
                            ...
                            <div className="text-center space-y-4">
                                ...
                                <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-teal-400">
                                    Stage 9: Live Indicator Tracking Dashboard
                                </h2>
                                <p className="text-xl text-cyan-200 max-w-4xl mx-auto">
                            ...
                            <div className="bg-gradient-to-br from-cyan-900/40 to-teal-900/40 p-6 rounded-xl border-2 border-cyan-400/30">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="space-y-3">
                                        <h3 className="text-xl font-bold text-cyan-300">From Planning to Practice: How Companies Monitor Scenarios</h3>
                            ...
                            <div className="bg-gradient-to-br from-pink-900/40 to-purple-900/40 p-8 rounded-xl border-2 border-pink-400/50">
                                <div className="mb-6">
                                    ...
                                    <img
                                        src={scenario4Image}
                                        alt="The Augmented Age"
                                        className="w-full rounded-lg border-2 border-pink-400/50 shadow-xl mb-4"
                                        style={{ maxWidth: '600px' }}
                                    />
                                    <h4 className="text-xl font-semibold text-pink-200">Indicator Dashboard</h4>
                                </div>

                                <div className="grid md:grid-cols-2 gap-6">
                                    {/* Left Column: Indicator Definitions */}
                                    <div className="space-y-4">
                                        <h4 className="font-semibold text-pink-200 mb-3">Monitored Indicators & Triggers</h4>
                                    ...
                                    <div className="space-y-4">
                                        <h4 className="font-semibold text-pink-200 mb-3">Current Status (Nov 2025)</h4>
                            ...
                            <div className="bg-gradient-to-br from-green-900/40 to-teal-900/40 p-8 rounded-xl border-2 border-green-400/50">
                                <div className="mb-6">
                                    ...
                                    <img
                                        src={scenario3Image}
                                        alt="The Waiting World"
                                        className="w-full rounded-lg border-2 border-green-400/50 shadow-xl mb-4"
                                        style={{ maxWidth: '600px' }}
                                    />
                                    <h4 className="text-xl font-semibold text-green-200">Indicator Dashboard</h4>
                                </div>

                                <div className="grid md:grid-cols-2 gap-6">
                                    {/* Left Column */}
                                    <div className="space-y-4">
                                        <h4 className="font-semibold text-green-200 mb-3">Monitored Indicators & Triggers</h4>
                                    ...
                                    {/* Right Column */}
                                    <div className="space-y-4">
                                        <h4 className="font-semibold text-green-200 mb-3">Current Status (Nov 2025)</h4>
                            ...
                            {/* Scenario 3: The Forbidden Frontier */}
                            <div className="bg-gradient-to-br from-purple-900/40 to-indigo-900/40 p-8 rounded-xl border-2 border-purple-400/50">
                                <div className="mb-6">
                                    ...
                                    <img
                                        src={scenario2Image}
                                        alt="The Forbidden Frontier"
                                        className="w-full rounded-lg border-2 border-purple-400/50 shadow-xl mb-4"
                                        style={{ maxWidth: '600px' }}
                                    />
                                    <h4 className="text-xl font-semibold text-purple-200">Indicator Dashboard</h4>
                                </div>

                                <div className="grid md:grid-cols-2 gap-6">
                                    {/* Left Column */}
                                    <div className="space-y-4">
                                        <h4 className="font-semibold text-blue-200 mb-3">Monitored Indicators & Triggers</h4>
                                    ...
                                    {/* Right Column */}
                                    <div className="space-y-4">
                                        <h4 className="font-semibold text-blue-200 mb-3">Current Status (Nov 2025)</h4>

                                        <div className="bg-black/40 p-4 rounded-lg">
                                            <div className="flex justify-between mb-2">
                                                <span className="text-sm font-semibold text-blue-200">Framework Completeness</span>
                                        ...
                                        <div className="bg-black/40 p-4 rounded-lg">
                                            <div className="flex justify-between mb-2">
                                                <span className="text-sm font-semibold text-blue-200">Standards Adoption</span>
                                        ...
                                        <div className="bg-black/40 p-4 rounded-lg">
                                            <div className="flex justify-between mb-2">
                                                <span className="text-sm font-semibold text-blue-200">Public Trust</span>
                                        ...
                                        <div className="bg-black/40 p-4 rounded-lg">
                                            <div className="flex justify-between mb-2">
                                                <span className="text-sm font-semibold text-blue-200">Approval Speed</span>
                            ...
                            <div className="bg-gradient-to-br from-blue-900/40 to-indigo-900/40 p-8 rounded-xl border-2 border-blue-400/50">
                                <div className="mb-6">
                                    ...
                                    <img
                                        src={scenario1Image}
                                        alt="The Hesitant Dawn"
                                        className="w-full rounded-lg border-2 border-blue-400/50 shadow-xl mb-4"
                                        style={{ maxWidth: '600px' }}
                                    />
                                    <h4 className="text-xl font-semibold text-blue-200">Indicator Dashboard</h4>
                                </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="bg-black/40 p-4 rounded-lg">
                                            <div className="flex justify-between mb-2">
                                                <span className="text-sm font-semibold text-green-200">Data Breaches</span>
                                        ...
                                        <div className="bg-black/40 p-4 rounded-lg">
                                            <div className="flex justify-between mb-2">
                                                <span className="text-sm font-semibold text-green-200">Moratorium Coverage</span>
                                        ...
                                        <div className="bg-black/40 p-4 rounded-lg">
                                            <div className="flex justify-between mb-2">
                                                <span className="text-sm font-semibold text-green-200">Funding Decline</span>
                                                <span className="text-xs text-green-300">✓ 38% to trigger</span>
                                            </div>
                                            <div className="space-y-2">
                                                <div>
