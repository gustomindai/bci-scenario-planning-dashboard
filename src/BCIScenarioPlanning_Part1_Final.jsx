                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl">
                    ...
                    {activeStage === 3 && (
                        <div className="space-y-6">
                            ...
                            <div className="mt-8">
                                <div className="bg-gradient-to-r from-purple-900/50 via-pink-900/50 to-purple-900/50 p-8 rounded-xl border-2 border-purple-400/50 text-center">
                                    <div className="mb-4">
                                        <AlertCircle className="w-16 h-16 text-yellow-400 mx-auto mb-4" />
                                        <h3 className="text-3xl font-bold text-purple-200 mb-3">End of Part 1</h3>
                                        <div className="w-32 h-1 bg-gradient-to-r from-transparent via-purple-400 to-transparent mx-auto mb-4"></div>
                                    </div>
                                    <p className="text-xl text-purple-100 mb-4 max-w-3xl mx-auto">
                                        Congratulations! You've completed the first four stages of the scenario planning process:
                                    </p>
                                    <div className="grid md:grid-cols-2 gap-4 max-w-4xl mx-auto mb-6">
                                        <div className="bg-black/30 p-4 rounded-lg">
                                            <p className="font-bold text-blue-300 mb-1">Stage 1: Focal Issue</p>
                                            <p className="text-sm text-gray-300">Defined our strategic question</p>
                                        </div>
                                        <div className="bg-black/30 p-4 rounded-lg">
                                            <p className="font-bold text-green-300 mb-1">Stage 2: PESTLE Scan</p>
                                            <p className="text-sm text-gray-300">Identified 40+ uncertainties</p>
                                        </div>
                                        <div className="bg-black/30 p-4 rounded-lg">
                                            <p className="font-bold text-orange-300 mb-1">Stage 3: Critical Drivers</p>
                                            <p className="text-sm text-gray-300">Mapped high-impact uncertainties</p>
                                        </div>
                                        <div className="bg-black/30 p-4 rounded-lg">
                                            <p className="font-bold text-pink-300 mb-1">Stage 4: Driver Connections</p>
                                            <p className="text-sm text-gray-300">Identified system relationships</p>
                                        </div>
                                    </div>
                                    <div className="bg-yellow-900/30 p-6 rounded-lg border border-yellow-500/40 max-w-3xl mx-auto">
                                        <p className="text-lg font-bold text-yellow-200 mb-2">Next Week: Completing the Journey</p>
                                        <p className="text-yellow-100">
                                            We'll continue with Stages 5-8, where we'll choose our scenario axes, craft narrative scenarios,
                                            assess their strategic impacts, and develop a comprehensive preparedness strategy.
                                        </p>
                                        <p className="text-yellow-200 text-sm mt-3 italic">
                                            See you next week for the complete scenario planning process!
                                        </p>
                                    </div>
                                </div>
                            </div>
